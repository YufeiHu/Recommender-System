...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "Q9cwTKFmlAAON08bY648QF8M0nm8jxzy";
    ...
    public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			// try will call in.close() automatically if BufferedReader is closable
	...
	/**
	 * Main entry for sample TicketMaster API requests. (local test)
	 */
